...
# --- 5. INVENTARIO ---
    ...
    with t1:
        ...
        st.info("💡 Haz clic en el círculo a la izquierda de un producto para seleccionarlo y habilitar acciones.")
        ...
        # Manejo seguro de la selección para evitar KeyError
        ...
        if role == "admin":
            ...
            # Panel de acciones si hay una fila seleccionada
            if selected_rows:
                st.markdown("---")
